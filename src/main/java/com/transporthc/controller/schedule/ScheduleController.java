package com.transporthc.controller.schedule;
...
import com.transporthc.service.schedule.schedule.ScheduleService;
...
public class ScheduleController {
    ...
    public ResponseEntity<Object> markComplete(@PathVariable String id, @Valid @RequestBody AttachedImgPathDto attachedImagePathsDto) throws ServerException {
